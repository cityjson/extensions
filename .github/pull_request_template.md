...
- [ ] selected a name that doesn't already exist and represents what my package does. It doesn't have spaces, and different words are linked by "-"
- [ ] added a `extension.toml` file with all required keys
