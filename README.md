...
This is the official registry for [CityJSON Extensions](https://www.cityjson.org/extension/). 
It provides a centralised location where developers can discover, submit, and maintain CityJSON Extensions that extend the core CityJSON specification.
...
| [noise](https://github.com/cityjson/extensions/tree/main/extensions/noise/2.0.0) | Extension for Noise Emission Simulation | 2.0.0 | [noise.ext.json](https://cityjson.github.io/extensions/noise/2.0.0/noise.ext.json) | [Hugo Ledoux](https://3d.bk.tudelft.nl/hledoux) |
...
| [val3dity](https://github.com/cityjson/extensions/tree/main/extensions/val3dity/0.3.0) | Extension to store val3dity validation reports and per-geometry diagnostics. | 0.3.0 | [val3dity.ext.json](https://cityjson.github.io/extensions/val3dity/0.3.0/val3dity.ext.json) | [Ravi Peters](https://github.com/ylannl) |
